const achievementData = {
    ...
    SmartIndiaHackathon: [
      ...
      { name: "Bhoomi Agarwal", achievements: ["Winner 2024"] },
    ...
    Hackathons: [
      ...
      { name: "Akash Sharma", achievements: [
          ...
          "2nd Runner-up in the Postman API hackathon @BITS Pilani"
        ] 
      },
      ...
      { name: "Bhuwan M, Naman Parlecha, Vivek Aggarwal, Mohit Nagraaj", achievements: ["Winner of Innerev 9.0 Hackathon"] },
      { name: "Gaurav Sarkar", achievements: [
          "3rd Prize in Academic Grand Challenge by Government of Telangana, Wells Fargo, and Nasscom",
          "Secured 3rd Prize in Bank of Baroda World Hackathon"
        ] 
      },
      { name: "Rithik Raj Pandey", achievements: [
          "Runner-up @ Hack-Star conducted by Mercedes Benz",
          "Runner-up @ Eureka 2022 conducted by IIT Bombay"
        ] 
      }
    ],
    CP: [
